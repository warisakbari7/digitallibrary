...
$('#bookform').ajaxForm({
    ...
    complete: function(result) {
        ...
        $("#b_lbl_finish").html('Register')
        $('#bookmodal').modal('hide');
        $("#title").text(result.responseJSON.book.title);
        $("#publish").html((d.getDate() + 1) + ' ' + date[d.getMonth()] + ' ' + d.getFullYear());
        $("#author").html(result.responseJSON.book.author);
        $("#pages").html(result.responseJSON.book.pages + ' Pages, ' + result.responseJSON.book.chapter + ' Chapters');
