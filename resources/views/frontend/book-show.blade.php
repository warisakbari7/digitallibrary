                        ...
                        <div id="book_container" class=" col-lg-9 col-md-10 col-sm-12 col-12 mt-5">
                            <div class="row"> 
                                <div class="col-lg-6 col-md-6 col-sm-6 " >
                                    <img id="lang" data-id="{{ $book->id }}" data-language="{{ $book->language }}" src="{{ asset('application/books/cover/'.$book->image) }}" class=" image-fluid shadow" style="height: 90%; width: 90%; border-radius:10px;" alt="{{ $book->title }}">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            @if(Auth::check())
                                                <div class="pt-lg-2 pb-2">
                                                    <a id="viewbtn" href="{{ asset('application/books/pdf/'.$book->path) }}"  target="_blank"><button  class="btn--outline--secondary btn-lg px-4 py-1 shadow mr-2 an_bold" style="width:120px"> <i></i> Read </button></a>
                                                    <a id="downloadbtn" href="{{ asset('application/books/pdf/'.$book->path) }}" download ><button  class="btn--outline--primary py-1 btn-lg px-4 shadow an_bold " style="width:120px"><i> </i> Download</button></a><br>
                                                </div>
                                            @else
                                                <div class="pt-lg-2 pb-2">
                                                    <a href="{{ route('view.book',$book->id) }}"><button class="btn--outline--secondary btn-lg px-4 py-1 shadow mr-2 an_bold"><i class="" style="width:120px !important"> </i> Read </button></a>
                                                    <a href="{{ route('download.book',$book->id) }}" ><button class="btn--outline--primary py-1 btn-lg px-4 shadow an_bold"><i  style="width:120px"> </i> Download</button></a><br>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12 p-2 ml-2">
                                            <ul class="list-inline">
                                                @foreach ($socialShare as $key=>$value )
                                                    ...
                                                    <li class="list-inline-item" style="border-radius:20px"> <a href="{{ $value }}"> <i class="fa fa-{{ $key }}"></i></a> </li>
                                                @endforeach                                                
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 p-2 ml-2 ">
                                            @if(Auth::check())
                                                ...
                                                @endif    
                                            @else
                                                <a href="{{ route('book.IsUserLogin',$book->id) }}"><button class="w-75 bg--two text-white an_bold rounded" style="border:none">Save</button></a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <li class="item-a">
                                                            <div class="box">
                                                                <div class="product-item position-relative">
                                                                    <img class="model" src="{{ asset("application/books/cover/".$rel->image) }}" alt="{{ $book->title }}">
                                                                    <div class="product-img-hover pt-5">
                                                                        <ul class=" list-inline text-center">
                                                                                <a href="{{ route('show.book',$rel->id) }}"><button class="btn--outline--secondary px-4 pt-1 pb-0 an_bold " style="font-size: 18px;" ><b>View</b></button></a>
                        ...
                        <div class="pl-1 mt-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @if(Auth::check())
                                                            ...
                                                            <div class="modal-body " >
                                                                <div class="row px-3 ">
                                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-3 pt-2">
                                                                        <img src="{{ asset('application/books/cover/'.$book->image) }}" class=" rounded shadow img-fluid" alt="{{ $book->tilte }}">
                                                                    </div>
                                    ...
                                    @endif
                                @else
                                    <a href="{{ route('allow.review',$book->id) }}" class="btn btn-primary bg--two An_light border-0  ml-4 py-0">Login to Add Review</a>
                                @endif
                                    ...
                                    <div class="mx-1 mt-2">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            @else
                                                <div class="text--five ml-5 d-flex align-items-center">
                                                    <h6 class="mb-0 An_light"><small>Helpful?</small></h6>
                                                    <a href="{{ route("allow.review",$book->id) }}" class=" p-0 m-0 nav-link bg--four small  text--two   px-2 rounded-left ml-2">Yes &nbsp;&nbsp; </a><span class="p-0 m-0 nav-link bg--four small  text--two rounded-right px-2" id="yesNum">{{ App\Helpers\Number::ToShortForm(count($review->helpfuls->where('helpful','yes'))) }}</span>
                                                    <a href="{{ route("allow.review",$book->id) }}" class="p-0 m-0 nav-link bg--four small  text--two rounded-left px-2   ml-2">No &nbsp;&nbsp;</a> <span class="p-0 m-0 nav-link bg--four small  text--two rounded-right px-2" id="noNum">{{ App\Helpers\Number::ToShortForm(count($review->helpfuls->where('helpful','no'))) }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body " >
                        <div class="row px-3 ">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-3 pt-2">
                                <img src="{{ asset('application/books/cover/'.$book->image) }}" class=" rounded shadow img-fluid" alt="{{ $book->title }}">
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                <div class="row">
                                    <div class="col-12">
                ...
                @if(Auth::check())
                    @if(Auth::user()->reviews->where('reviewable_id',$book->id)->where("reviewable_type","App\Models\Book")->first() != "")
                        <form id="editReviewForm" method="POST" action="{{ route('review.update',Auth::user()->reviews->where('reviewable_id',$book->id)->where('reviewable_type','App\Models\Book')->first()->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row mx-3 bg--four px-3 py-1 rounded shadow mt-3 mx-0 justify-content-center">
                                <div class="d-flex align-items-center px-4 justify-content-center">
...
@endsection 
@push('script')
    <script src="{{ asset('app/js/book/frontend/download-book.js') }}"></script>
    <script src="{{ asset('app/js/book/frontend/review-book.js') }}"></script>
    <script>
            $(document).ready(()=>{
