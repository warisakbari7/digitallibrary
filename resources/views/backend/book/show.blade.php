                        ...
                        <div id="book" class=" col-lg-9 col-md-10 col-sm-12 col-12 mt-5">
                            <div class="row"> 
                                <div class="col-lg-6 col-md-6 col-sm-6 " >
                                    <img id="lang" data-id="{{ $book->id }}" data-language="{{ $book->language }}" src="{{ asset('application/books/cover/'.$book->image) }}" style="height: 90%; width: 90%; border-radius:10px;" alt="{{ $book->title }}">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                                <div class=" pl-1 pt-lg-5 mt-lg-5 pt-4 ">
                                                        <a href="{{ asset('application/books/pdf/'.$book->path) }}" target="_blank"><button class=" btn  bg-warning px-4 py-1 text-white shadow mr-2 an_bold"> Read </button></a>
                                                        <a href="{{ asset('application/bookss/pdf/'.$book->path) }}" download="download"><button  class=" py-1 btn bg-success px-4 shadow an_bold">Download</button></a><br>
                                                        <a href="javascript:void(0)" data-target="#bookmodal" data-toggle="modal"><button class="mt-5 bg-primary border-primary btn px-4 py-1 shadow mr-2 an_bold">Edite</button></a>
                ...
                <div class="modal-body bookemodal bg--four rounded">
                    <form class="px-4" id="bookform" action="{{ route('book.update',$book->id) }}" method="POST">
                        ...
                        <div class="form-group row  mx-0 ">
                            ...
                            <input type="hidden" name="b_edition" id="b_edition" value="{{ $book->edition }}">
...
@push('script')
<script src="{{ asset('app/js/book/backend/review-book.js') }}"></script>
