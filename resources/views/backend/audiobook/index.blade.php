...
<div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12">
            <button class="btn btn-secondary mb-2 ml-1" data-target="#bookmodal" data-toggle="modal"> <i class="fa fa-plus" > </i> Add Audio</button>
            <div class="card card-secondary">
              <div class="card-header bg-secondary">
                <h3 class="card-title">Audio Books</h3>
                ...
                <div class="modal-dialog  " style=" max-width: 800px !important;" role="document">
                    <div class="modal-content p-0 border-0">
                        <div class="modal-header text-center  bg-secondary align-items-center border-0 py-2 ">
                            <h4 class=" mb-0 text-white text-center w-100 an_bold pt-2" id="exampleModalLabel">Add New Audio Book </h5>
                        ...
                        <div class="modal-body bookmodal bg--four rounded">
                            <form class="px-4" id="bookform" action="{{ route('audiobook.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="form-group w-75 col-4">
                                        <div class="row">
                                            <label for="exampleFormControlFile1"><b  class="an_bold" id="lbl_b_book">Book</b> <small>(mp3 file)</small></label>
                                        </div>
                                        <div class="row">
                                                <label for="b_book" class="custom-file border-0 shadow rounded small bg-primary mr-3 text-white  text-center pb-0 pt-1 " style="
                                                cursor: pointer;" id="b_bookbutton">Upload</label>
                                        </div>
                                        <div class="row p-2">
                                                <small class="b_book">*Note: mp3 size should not be more then 200 MB</small>
                                                <input type="file" id="b_book" name="b_book" class="custom-file-input" accept=".mp3">
                                        </div>
                                    ...
                                    <div class="form-group w-75 col-4">
                                        ...
                                        <div class="row p-2">
                                                <input  type="file" id="b_cover" name="b_cover" class="custom-file-input" accept="image/jpeg, image/jpg, image/png">
...
<script src="{{ asset('app/js/audiobook/backend/search-books.js') }}"></script>
<script src="{{ asset('app/js/audiobook/backend/book-form.js') }}"></script>
@endpush