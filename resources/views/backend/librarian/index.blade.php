...
<div class="container-fluid">
  ...
  <div class="card card-secondary">
    <div class="card-header">
      <h3 class="card-title"> Librarian Registration Form</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body mb-0">
      <form action="{{ route('librarian.store') }}" method="POST" id="librarian_form">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <select multiple="" class="custom-select" name="catagories[]" id="catagories">
                @foreach ($catagory as $cat)
                <option value="{{ $cat->id }}">{{ $cat->ename }}</option>
                @endforeach
              </select>
              <br>
              <span class="ml-2 text-danger catagories_error"></span>
            </div>
...
<!-- The Modal Fom for updating record -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" id="UpdateForm" method="POST">
          ...
          @method('PUT')
          <div class="input-group">
            <input id="upic" type="file" class="custom-file-input" name="image">
            <label id="label" class="custom-file-label" for="exampleInputFile">Choose Image</label>
          </div>
          <span class="ml-2 text-danger uimage_error"></span>
          <div class="form-group">
            <label for="">Name</label>
            <input type="text" name="name" id="uname" class="form-control">
            <span class="ml-2 text-danger uname_error"></span>
          </div>
          <div class="form-group">
            <label for="">Last Name</label>
            <input type="text" name="lastname" id="ulastname" class="form-control">
          <span class="ml-2 text-danger ulastname_error"></span>
          </div>
          <div class="form-group">
            <label for="">Email</label>
            <input type="email" name="email" id="uemail" class="form-control">
          <span class="ml-2 text-danger uemail_error"></span>
          </div>
          <div class="form-group">
            <label for="">Occupation</label>
            <input type="text" name="occupation" id="uoccupation" class="form-control">
          <span class="ml-2 text-danger uoccupation_error"></span>
          </div>
          <div class="form-group">
            <label for="">Live in</label>
            <input type="text" name="live" id="ulive" class="form-control">
          <span class="ml-2 text-danger ulive_error"></span>
          </div>
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" id="update_btn" class="btn btn-primary" style="width:120px;">Update</button>
...
<!-- The Modal Fom for displaying message-->
...
@endsection
@push('script')
<script src="{{ asset('app/js/librarian/librarian.js') }}"></script>
@endpush